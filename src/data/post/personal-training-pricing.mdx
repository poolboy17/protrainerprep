...
excerpt: >
  A data-driven pricing guide written for trainers, not clients. Session rates by model and experience level, package structures, and the math to hit your income target.
