...
**NSCA CSCS** — **Bachelor's degree required** (any field). This is the exception, not the rule. The CSCS is a specialized strength and conditioning credential, not a standard personal training certification. See our [CSCS review](/certifications/nsca-cscs-review).
