...
<SpokeCards
  cards={[
    ...
    { title: "NCSF vs ISSA", description: "NCCA-accredited value vs distance-learning flexibility.", href: "/certifications/ncsf-vs-issa" },
    { title: "ACE vs ISSA", description: "Behavior change coaching vs self-paced distance learning.", href: "/certifications/ace-vs-issa" },
    { title: "NASM vs NSCA", description: "CPT vs CSCS — two different credentials for two different careers.", href: "/certifications/nasm-vs-nsca" },
    ...
    { title: "Personal Trainer Study Guide", description: "Week-by-week study plan, cert-specific tips, and strategies that pass exams.", href: "/certifications/personal-trainer-study-guide" },
    { title: "ACSM CPT Review", description: "Clinical research reputation, cost, and who benefits from ACSM's premium.", href: "/certifications/acsm-cpt-review" },
    { title: "NSCA CPT Review", description: "Strength-focused CPT from the CSCS organization — how it compares.", href: "/certifications/nsca-cpt-review" },
    { title: "ISSA vs NASM", description: "Distance-learning flexibility vs industry-leading brand recognition.", href: "/certifications/issa-vs-nasm" },
    { title: "ACE vs NCSF vs NASM", description: "Three NCCA-accredited CPTs compared on cost, curriculum, and value.", href: "/certifications/ace-vs-ncsf-vs-nasm" }
  ]}
/>
