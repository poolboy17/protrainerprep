...
<SpokeCards
  cards={[
    ...
    { title: "Personal Trainer Insurance", description: "Liability coverage, costs, and what's required vs. optional by business model.", href: "/career-building/personal-trainer-insurance" },
    { title: "Client Retention Strategies", description: "Why retention beats acquisition, the metrics that matter, and how to reduce churn.", href: "/career-building/personal-trainer-client-retention" },
    ...
    { title: "Continuing Education Guide", description: "Which CE courses raise your rates vs just check a box.", href: "/career-building/personal-trainer-continuing-education" }
  ]}
/>
